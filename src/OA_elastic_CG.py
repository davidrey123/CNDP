...
class OA_elastic_CG:
    ...
    def initRMP(self):   
        ...
        self.rmp.objfunc = (1-self.obj_weight) * sum(self.rmp.mu_a[a] for a in self.network.links if a in self.x_target) + self.obj_weight * sum(self.rmp.mu_w[(r,s)] for r in self.network.origins for s in r.getDests())
